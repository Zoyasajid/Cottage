          ...
          <div className="formDiv sign">
            <div className="form">
              <div className="signloginBtns signInbtn">
                <button onClick={signin} className="signIn signInUP">
                  Sign In
                </button>
                <button onClick={signup} className="signUps signupin">
                  Sign Up
                </button>
              </div>
              <form>
                <div className="signin">
                  ...
                  <p className="terms op">
                    {" "}
                    <span onClick={chng}>Forgot Password?</span>
                  </p>
